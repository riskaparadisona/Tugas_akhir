...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{ asset('frontend/img/logonike.jpeg') }}" alt="" /></a>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> kelompok.bootcamp.com</li>
                                <li>Diskon Up To 25%</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="{{ asset('frontend/img/logonike.jpeg') }}"
                                    alt="" /></a>
                        </div>
                        <ul>
                            <li>Address: 60-49 Road 11378 Unilak</li>
                            <li>Phone: +688884</li>
                            <li>Email: kelompok.bootcamp.com</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer__copyright">
                        <div class="footer__copyright__text">
                            <p>
                                ...
                                <a href="https://colorlib.com" target="_blank">KELOMPOK.BOOTCAMP</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
